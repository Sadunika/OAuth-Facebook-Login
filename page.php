...
if (isset($accessToken)) {
    ...
    try {
		...
		if(isset($_POST['insert'])){
     	$data = ['source' => $fb->fileToUpload(__DIR__.'/photo.jpeg'), 'message' => 'Check out this app! It is awesome http://localhost/OAuth-Facebook-Login/i.pnp '];
...
<body>
         ...
         <div class="headnameline">
            <center><h1 class="warning"><b><?php echo $name." is your Look Alike!"; ?></b></h1></center>
            </div>
